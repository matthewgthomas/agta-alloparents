...
model{
    ...
    b_childdepend ~ normal( 0 , 5 );
    b_giverdepend ~ normal( 0 , 5 );
    b_childcarer ~ normal( 0 , 5 );
    b_givercarer ~ normal( 0 , 5 );
    //b_location ~ normal( 0 , 5 );
    b_cost ~ normal( 0 , 5 );
    b_need ~ normal( 0 , 5 );
...
// LIKELIHOOD
    for ( i in 1:N ) {
        ...
        + b_childdepend * childdepend[i]
   		  + b_giverdepend * giverdepend[i]
   		  + b_childcarer * childcarer[N]
   		  + b_givercarer + givercarer[N]
   		  //+ b_location + location[N]
   		  + b_cost * cost[N]
   		  + b_need * need[N]
...
/*	
    ...
    log_lik[i] = poisson_log_lpmf(y[i] | a
        ...
        + b_childage * childage[i]
   		  + b_childsex * childsex[i]
   		  
   		  + b_r * r[N]
   		  + b_cost * cost2[N]
   		  + b_need * need[N]
   		  + b_samecluster * samecluster[N]
   		  + b_learn * learn[N]
   		  + b_signal * signal[N]
